        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-6 relative">
          ...
          >
            ...
            <div className="relative z-10">
              <div className="text-7xl md:text-8xl font-instrument mb-4 tracking-tighter text-white">12,482</div>
          ...
          >
             ...
             <div>
               <div className="text-5xl font-instrument mb-2 text-white">4.8</div>
        ...
        <div className="max-w-7xl mx-auto flex flex-col xl:flex-row items-center justify-between gap-16 relative z-10">
          <div className="max-w-xl">
            ...
            <div className="flex items-center space-x-8">
              ...
              <div>
                <div className="text-4xl font-instrument mb-1 text-white">1.2M+</div>
