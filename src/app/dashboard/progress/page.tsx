        ...
        <div className="flex flex-col space-y-4 md:flex-row md:justify-between md:items-center md:space-y-0">
          ...
          <div className="flex items-center space-x-3">
            <button
              ...
              className="flex items-center space-x-2.5 bg-white/5 border border-white/5 hover:border-white/15 px-4.5 py-2.5 rounded-xl text-white/80 hover:text-white font-manrope font-bold text-xs uppercase tracking-widest transition-all cursor-pointer"
            >
