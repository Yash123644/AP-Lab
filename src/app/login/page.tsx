          ...
          <div className="w-full max-w-[400px] mx-auto">
            ...
            <div className="grid grid-cols-3 gap-4 mb-6">
              ...
              <button
                ...
                disabled={loading}
                className="flex items-center justify-center py-3 bg-white/5 hover:bg-white/10 border border-white/25 hover:border-white/40 rounded-xl transition-all group disabled:opacity-50"
                title="Continue with Google"
              >
                {/* Full colors by default, solid bright on hover */}
              ...
              <div className="space-y-2">
                ...
                <div className="relative flex items-center">
                  ...
                  <button
                    ...
                    className="absolute right-4 text-white/40 hover:text-white/70 transition-colors focus:outline-none p-1"
                  >
