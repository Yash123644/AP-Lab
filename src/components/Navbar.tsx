...
export function Navbar() {
  ...
  return (
    <>
      <nav className={cn(
        "fixed top-4 sm:top-5 left-1/2 -translate-x-1/2 w-[94%] max-w-6xl rounded-full px-5 sm:px-6 md:px-8 z-50 transition-all duration-300 flex items-center justify-between",
        isScrolled 
        ...
        <div className="flex-1 flex justify-end items-center">
          <div className="hidden md:flex items-center space-x-6">
            {currentUser ? (
              ...
              >
                <button className={cn(
                  "font-manrope font-bold text-[13px] transition-all duration-200 flex items-center px-5 py-2.5 rounded-full bg-white text-black hover:bg-white/90 shadow-md active:scale-95",
                  (pathname === "/dashboard" || hoveredHref === "/dashboard") && "ring-2 ring-white/40"
                )}>
                  <AnimatePresence initial={false}>
