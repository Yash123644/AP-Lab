...
const TikTokIcon = (props: React.SVGProps<SVGSVGElement>) => (
  <svg viewBox="0 0 24 24" className={props.className}>
    ...
    <path d="M16.6 9.5a3.5 3.5 0 0 1-2.5-1.2v4.7a3.5 3.5 0 1 1-5-3.1v2.7a1 1 0 1 0 2.5 1V3h2.5a3.5 3.5 0 0 0 3.5 3.5v3z" fill="#FFFFFF" />
    <path d="M16.6 9.5a3.5 3.5 0 0 1-2.5-1.2v4.7a3.5 3.5 0 1 1-5-3.1" stroke="#25F4EE" strokeWidth="0.8" fill="none" transform="translate(-0.5, -0.5)" />
    <path d="M14.1 3h2.5a3.5 3.5 0 0 0 3.5 3.5" stroke="#FE2C55" strokeWidth="0.8" fill="none" transform="translate(0.5, 0.5)" />
  </svg>
);
...
const DiscordIcon = (props: React.SVGProps<SVGSVGElement>) => (
  <svg viewBox="0 0 24 24" className={props.className}>
    ...
    <path d="M17.4 9.1c-.6-.5-1.3-.8-2-.9-.1 0-.2.1-.2.2.3.1.6.3.8.5-.2-.1-.5-.2-.7-.3-.4-.1-.8-.2-1.2-.2-.5-.1-1-.1-1.4 0-.4.1-.8.2-1.2.2-.2.1-.5.2-.7.3.2-.2.5-.4.8-.5-.1-.1-.1-.2-.2-.2-.7.1-1.4.4-2 .9-.5.6-1 1.4-1.1 2.4.9 1.1 2.2 1.7 3.6 1.7h.1c.4-.5.7-1.1 1-1.6-.7-.2-1.3-.5-1.9-.9.1-.1.2-.2.3-.3.6.4 1.2.7 1.9.9.3.6.6 1.2 1 1.6h.1c1.4 0 2.7-.6 3.6-1.7-.1-1-.6-1.8-1.1-2.4zm-5.4 3.3c-.4 0-.8-.4-.8-.8s.4-.8.8-.8.8.4.8.8-.4.8-.8.8zm3.2 0c-.4 0-.8-.4-.8-.8s.4-.8.8-.8.8.4.8.8-.4.8-.8.8z" fill="#FFFFFF" />
  </svg>
);
...
const ChatGPTIcon = (props: React.SVGProps<SVGSVGElement>) => (
  <svg viewBox="0 0 24 24" className={props.className}>
    ...
    <path d="M18.8 11.2c-.1-.7-.4-1.3-.9-1.7.3-.8.4-1.7.2-2.5-.3-.9-1-1.7-1.9-2-1-.3-2.1-.1-2.9.5-.6-.5-1.4-.8-2.2-.8-.9 0-1.8.5-2.3 1.3-.8-.3-1.7-.3-2.5 0-.9.3-1.6 1.1-1.9 2-.3.9-.1 2 .5 2.8-.5.5-.8 1.3-.8 2.1 0 .9.5 1.7 1.2 2.2-.3.8-.4 1.7-.1 2.5.3.9 1 1.7 1.9 2 1 .3 2.1.1 2.9-.5.6.5 1.4.8 2.2.8.9 0 1.8-.5 2.3-1.3.8.3 1.7.3 2.5 0 .9-.3 1.6-1.1 1.9-2 .3-.9.1-2-.5-2.8.5-.5.8-1.3.8-2.1zM9.4 6.7c.3-.5.9-.9 1.5-.9h.2c.6.1 1.1.4 1.4.9l.4.7c-.4.2-.8.5-1.1.8l-1.9-1.1-.5-.4zm-2 4c.1-.6.5-1.1 1-1.4l.2-.1c.6-.2 1.2-.1 1.6.2l.4.7c-.2.4-.3.9-.3 1.3L8.1 12l-.7-.7zm1.6 4.9c-.3-.5-.4-1.2-.2-1.8l.1-.2c.2-.6.7-1 1.2-1.2l.8-.2v.8c0 .4.2.8.5 1.1l-1.9 1.1-.5-.4zm5.6 1.7c-.3.5-.9.9-1.5.9h-.2c-.6-.1-1.1-.4-1.4-.9l-.4-.7c.4-.2.8-.5 1.1-.8l1.9 1.1.5.4zm2-4c-.1.6-.5 1.1-1 1.4l-.2.1c-.6.2-1.2.1-1.6-.2l-.4-.7c.2-.4.3-.9.3-1.3l2.2-.6.7.7zm-1.6-4.9c.3.5.4 1.2.2 1.8l-.1.2c-.2.6-.7 1-1.2 1.2l-.8.2v-.8c0-.4-.2-.8-.5-1.1l1.9-1.1.5.4z" fill="#000000" />
  </svg>
);
...
const WhatsAppIcon = (props: React.SVGProps<SVGSVGElement>) => (
  <svg viewBox="0 0 24 24" className={props.className}>
    ...
    <path d="M12.003 6.002a5.97 5.97 0 0 0-5.187 8.948L6 18l3.14-.823a5.96 5.96 0 0 0 2.863.731h.003a5.97 5.97 0 0 0 5.997-5.997 5.96 5.96 0 0 0-5.997-5.997zm3.178 8.608c-.13.364-.755.7-1.042.744-.282.044-.567.067-1.78-.423-1.462-.592-2.39-2.077-2.463-2.174-.074-.096-.6-.798-.6-1.528 0-.73.383-1.09.519-1.24.135-.148.297-.185.396-.185h.282c.092 0 .215.004.312.23.102.24.346.842.376.904.03.063.05.137.008.223-.043.086-.065.139-.129.214-.064.075-.135.168-.193.226-.065.066-.133.137-.058.266.076.128.337.556.723.9 1.1.98 2.02 1.284 2.306 1.427.287.143.454.12.622-.075.168-.194.736-.856.931-1.15.195-.295.39-.247.658-.148.268.1.1.1.2.2.072.12.072.7-.215 1.503z" fill="#FFFFFF" />
  </svg>
);
