...
const DiscordIcon = (props: React.SVGProps<SVGSVGElement>) => (
  <svg viewBox="0 0 24 24" className={props.className}>
    ...
    <g transform="translate(3.5, 3.5) scale(0.7)">
      <path d="M20.317 4.3698a19.7913 19.7913 0 0 0-4.8851-1.5152.0741.0741 0 0 0-.0785.0371c-.211.3753-.4447.864-.6083 1.2495a18.2578 18.2578 0 0 0-5.4877 0 12.6407 12.6407 0 0 0-.617-1.2495.077.077 0 0 0-.0785-.037 19.7363 19.7363 0 0 0-4.8852 1.515.0699.0699 0 0 0-.0321.0277C.5334 9.0458-.319 13.5799.0992 18.0578a.0824.0824 0 0 0 .0312.0561c2.0528 1.5076 4.0413 2.4228 5.9929 3.0294a.0777.0777 0 0 0 .0842-.0276c.4616-.6304.8731-1.2952 1.226-1.9942a.076.076 0 0 0-.0416-.1057c-.6528-.2476-1.2743-.5495-1.8722-.8923a.077.077 0 0 1-.0076-.1277c.1258-.0943.2517-.1923.3718-.2914a.0743.0743 0 0 1 .0776-.0105c3.9278 1.7933 8.18 1.7933 12.0614 0a.0739.0739 0 0 1 .0785.0095c.1202.099.246.1971.3728.2924a.077.077 0 0 1-.0066.1276 12.2986 12.2986 0 0 1-1.873.8914.0766.0766 0 0 0-.0407.1067c.3604.698.7719 1.3628 1.225 1.9932a.076.076 0 0 0 .0842.0286c1.961-.6067 3.9495-1.5219 6.0023-3.0294a.077.077 0 0 0 .0313-.0552c.5004-5.177-.8382-9.6739-3.5485-13.6604a.061.06 0 0 0-.0312-.0286zM8.02 15.3312c-1.1825 0-2.1569-1.0857-2.1569-2.419 0-1.3332.9555-2.4189 2.157-2.4189 1.2108 0 2.1757 1.0951 2.1568 2.419 0 1.3332-.9555 2.4189-2.1569 2.4189zm7.9748 0c-1.1825 0-2.1569-1.0857-2.1569-2.419 0-1.3332.9554-2.4189 2.1569-2.4189 1.2108 0 2.1756 1.0951 2.1568 2.419 0 1.3332-.946 2.4189-2.1568 2.4189z" fill="#FFFFFF" />
    </g>
  </svg>
);
...
const ChatGPTIcon = (props: React.SVGProps<SVGSVGElement>) => (
  <svg viewBox="0 0 24 24" className={props.className}>
    ...
    <g transform="translate(3.5, 3.5) scale(0.7)">
      <path d="M22.2819 9.8211a5.9847 5.9847 0 0 0-.5157-4.9108 6.0462 6.0462 0 0 0-4.1024-3.13 6.002 6.002 0 0 0-4.9085.518 6.0462 6.0462 0 0 0-3.13 4.1024 5.9847 5.9847 0 0 0-.5181 4.9085 6.0462 6.0462 0 0 0 4.1024 3.13 6.002 6.002 0 0 0 4.9085-.5157 6.0462 6.0462 0 0 0 3.13-4.1024zm-8.8743-7.5342a4.42 4.42 0 0 1 1.2882-.293c.4856-.0027.9703.09 1.4177.2727.4243.1764.8087.4475 1.127.7951l.2202.2612a4.37 4.37 0 0 0-1.1717.6521L14.73 3.6596l-.6897-.3982V2.836a3.52 3.52 0 0 0-.2562-1.2995 3.56 3.56 0 0 0-.8298-.9804l-.6897-.3982zM4.7766 8.3582a4.42 4.42 0 0 1 .1575-1.3094 4.54 4.54 0 0 1 .7157-1.2467c.2982-.36.6713-.6471 1.0935-.8418l.3015-.1216c.2772.3789.4975.803.6521 1.2541l.288 1.4132-1.2222.7056a4.37 4.37 0 0 0-1.297 1.0935l-.6897-.3982zM7.22 13.9188a4.42 4.42 0 0 1-.5045-1.2186c-.161-.4765-.22-.9773-.1737-1.4727l.1193-.3219c.4082.2227.7818.5147 1.1042.8617l1.011 1.011v1.1685a3.52 3.52 0 0 0 .5045 1.2186c.22.463.541 1.002.943 1.1685l-1.9213 1.1093-.5045-.2912a4.42 4.42 0 0 1-1.583-3.2332zM12.0153 22.0298a4.42 4.42 0 0 1-1.2882.293c-.4856.0027-.9703-.09-1.4177-.2727a4.54 4.54 0 0 1-1.127-.7951l-.2202-.2612a4.37 4.37 0 0 0 1.1717-.6521l2.5593-1.4777.6897.3982v.4254c0 .4856.09 1.1685.2562 1.2995.1764.4243.4875.8087.8298.9804l.6897.3982zM19.4587 15.8236a4.42 4.42 0 0 1-.1575 1.3094 4.54 4.54 0 0 1-.7157 1.2467a4.54 4.54 0 0 1-1.0935.8418l-.3015.1216a4.37 4.37 0 0 0-.6521-1.2541l-.288-1.4132 1.2222-.7056c.49-.283.931-.655 1.297-1.0935l.6897.3982zM16.9767 10.37a4.42 4.42 0 0 1 .5045 1.2186c.161.4765.22.9773.1737 1.4727l-.1193.3219a4.37 4.37 0 0 0-1.1042-.8617l-1.011-1.011v-1.1685a3.52 3.52 0 0 0-.5045-1.2186c-.22-.463-.541-1.002-.943-1.1685l1.9213-1.1093.5045.2912a4.42 4.42 0 0 1 1.583 3.2332z" fill="#000000" />
    </g>
  </svg>
);
